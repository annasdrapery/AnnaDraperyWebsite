...
namespace Nop.Services.Tests.Orders
{
    ...
    public class OrderProcessingServiceTests : ServiceTest
    {
        ...
        private IPOTemplateMessageService _pOTemplateMessageService;
        ...
        public new void SetUp()
        {
            ...
            _priceCalcService = new PriceCalculationService(_workContext, _storeContext,
                ...
                cacheManager, _shoppingCartSettings,null, _catalogSettings);
            ...
            _pOTemplateMessageService = MockRepository.GenerateMock<IPOTemplateMessageService>();
            _purchaseOrderService = MockRepository.GenerateMock<IPurchaseOrderService>();
            ...
            _orderProcessingService = new OrderProcessingService(_orderService, _webHelper,
                ...
                _orderSettings, _taxSettings, _localizationSettings,_pOTemplateMessageService,_purchaseOrderService,
                _currencySettings);
        }
