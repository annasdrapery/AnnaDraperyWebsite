...
namespace Nop.Services.Shipping
{
    ...
    public partial interface IShippingService
    {
        ...
        IList<ShippingFeeByOrderTotal> GetAllShippingFees();
        ShippingFeeByOrderTotal GetShippingFeeById(int Id);
        void InsertShippingFee(ShippingFeeByOrderTotal shipping);
        void UpdateShippingFee(ShippingFeeByOrderTotal shipping);
        void DeleteShipmentFee(ShippingFeeByOrderTotal shipping);
        decimal GetShippingFeeByTotalOrder(decimal orderTotal);
    }
}
