...
namespace Nop.Services.Orders
{
    ...
    public partial class ShoppingCartService : IShoppingCartService
    {
        ...
        public virtual IList<string> AddToCart(Customer customer, Product product,
            ...
            DateTime? rentalStartDate = null, DateTime? rentalEndDate = null,
            int quantity = 1, bool automaticallyAddRequiredProductsIfEnabled = true,
             decimal selectedRodWidth = 0, decimal selectedRodWidtheven = 0, decimal unitPrice = 0)
        {
            if (customer == null)
                throw new ArgumentNullException("customer");
            ...
            else
            {
                ...
                if (warnings.Count == 0)
                {
                    ...
                    shoppingCartItem = new ShoppingCartItem
                    {
                        ...
                        CreatedOnUtc = now,
                        UpdatedOnUtc = now,
                        SelectedRodWidth = selectedRodWidth,
                        SelectedRodWidtheven = selectedRodWidtheven,
                        UnitPrice = unitPrice
                    };
            ...
            if (shoppingCartItem != null)
            {
                ...
                if (quantity > 0)
                {
                    ...
                    if (warnings.Count == 0)
                    {
                        ...
                        shoppingCartItem.UpdatedOnUtc = DateTime.UtcNow;
                        shoppingCartItem.SelectedRodWidth = selectedRodWidth;
                        shoppingCartItem.SelectedRodWidtheven = selectedRodWidtheven;
