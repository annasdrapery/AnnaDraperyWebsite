...
namespace Nop.Services.ExportImport
{
    ...
    public partial class ExportManager : IExportManager
    {
        ...
        public string ExportBrandsToXml(IList<Brand> brands)
        {
            var sb = new StringBuilder();
            var stringWriter = new StringWriter(sb);
            var xmlWriter = new XmlTextWriter(stringWriter);
            ...
            foreach (var brand in brands)
            {
                ...
                //xmlWriter.WriteElementString("BrandTemplateId", null, brand.BrandTemplateId.ToString());
                xmlWriter.WriteElementString("MetaKeywords", null, brand.MetaKeywords);
                xmlWriter.WriteElementString("MetaDescription", null, brand.MetaDescription);
                xmlWriter.WriteElementString("MetaTitle", null, brand.MetaTitle);
                xmlWriter.WriteElementString("SEName", null, brand.GetSeName(0));
                ...
                xmlWriter.WriteElementString("AllowCustomersToSelectPageSize", null, brand.AllowCustomersToSelectPageSize.ToString());
                xmlWriter.WriteElementString("PageSizeOptions", null, brand.PageSizeOptions);
                ...
                xmlWriter.WriteElementString("CreatedOnUtc", null, brand.CreatedOnUtc.ToString());
                xmlWriter.WriteElementString("UpdatedOnUtc", null, brand.UpdatedOnUtc.ToString());
