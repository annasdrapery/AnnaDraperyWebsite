    ...
    public partial class ProductService : IProductService
    {
            ...
            int brandId = 0)
        {
            ...
            return SearchProducts(out filterableSpecificationAttributeOptionIds, false,
                ...
                orderBy, showHidden, overridePublished, brandId);
        }
        ...
        public virtual IPagedList<Product> SearchProducts(
            ...
            string poleDiameters = null,
            string colllectionTypeIds = null,
            string finialTypeIds = null,
            string poleLengths = null,
            string bracketTypeIds = null,
            string innerDiameters = null,
            string outerDiameters = null,
            string accessoriesTypeIds = null,
            string rodsTypeIds = null,
            string decorativeTypeIds = null,
            string rodsOptionTypeIds = null,
            string poleTypeIds = null,
            string adjustableSizes = null
            )
        {
            ...
            if (_commonSettings.UseStoredProceduresIfSupported && _dataProvider.StoredProceduredSupported)
            {
                ...
                //hardware
                var pBrandIds = _dataProvider.GetParameter();
                pBrandIds.ParameterName = "BrandIds";
                pBrandIds.Value = !String.IsNullOrEmpty(brandIds) ? (object)brandIds : DBNull.Value;
                pBrandIds.DbType = DbType.String;

                var pProductTypeIds = _dataProvider.GetParameter();
                pProductTypeIds.ParameterName = "ProductTypeIds";
                pProductTypeIds.Value = !String.IsNullOrEmpty(productTypeIds) ? (object)productTypeIds : DBNull.Value;
                pProductTypeIds.DbType = DbType.String;

                var pPoleDiameters = _dataProvider.GetParameter();
                pPoleDiameters.ParameterName = "PoleDiameters";
                pPoleDiameters.Value = !String.IsNullOrEmpty(poleDiameters) ? (object)poleDiameters : DBNull.Value;
                pPoleDiameters.DbType = DbType.String;

                var pCollectionStyleIds = _dataProvider.GetParameter();
                pCollectionStyleIds.ParameterName = "CollectionStyleIds";
                pCollectionStyleIds.Value = !String.IsNullOrEmpty(colllectionTypeIds) ? (object)colllectionTypeIds : DBNull.Value;
                pCollectionStyleIds.DbType = DbType.String;

                var pFinialStyleIds = _dataProvider.GetParameter();
                pFinialStyleIds.ParameterName = "FinialStyleIds";
                pFinialStyleIds.Value = !String.IsNullOrEmpty(finialTypeIds) ? (object)finialTypeIds : DBNull.Value;
                pFinialStyleIds.DbType = DbType.String;

                var pPoleLengths = _dataProvider.GetParameter();
                pPoleLengths.ParameterName = "PoleLengths";
                pPoleLengths.Value = !String.IsNullOrEmpty(poleLengths) ? (object)poleLengths : DBNull.Value;
                pPoleLengths.DbType = DbType.String;

                var pBracketStyleIds = _dataProvider.GetParameter();
                pBracketStyleIds.ParameterName = "BracketStyleIds";
                pBracketStyleIds.Value = !String.IsNullOrEmpty(bracketTypeIds) ? (object)bracketTypeIds : DBNull.Value;
                pBracketStyleIds.DbType = DbType.String;

                var pInnerDiameters = _dataProvider.GetParameter();
                pInnerDiameters.ParameterName = "InnerDiameters";
                pInnerDiameters.Value = !String.IsNullOrEmpty(innerDiameters) ? (object)innerDiameters : DBNull.Value;
                pInnerDiameters.DbType = DbType.String;

                var pOuterDiameters = _dataProvider.GetParameter();
                pOuterDiameters.ParameterName = "OuterDiameters";
                pOuterDiameters.Value = !String.IsNullOrEmpty(outerDiameters) ? (object)outerDiameters : DBNull.Value;
                pOuterDiameters.DbType = DbType.String;

                var pAccessoriesStyleIds = _dataProvider.GetParameter();
                pAccessoriesStyleIds.ParameterName = "AccessoriesStyleIds";
                pAccessoriesStyleIds.Value = !String.IsNullOrEmpty(accessoriesTypeIds) ? (object)accessoriesTypeIds : DBNull.Value;
                pAccessoriesStyleIds.DbType = DbType.String;

                var pRodsTypeIds = _dataProvider.GetParameter();
                pRodsTypeIds.ParameterName = "RodsTypeIds";
                pRodsTypeIds.Value = !String.IsNullOrEmpty(rodsTypeIds) ? (object)rodsTypeIds : DBNull.Value;
                pRodsTypeIds.DbType = DbType.String;

                var pDecorativeTypeIds = _dataProvider.GetParameter();
                pDecorativeTypeIds.ParameterName = "DecorativeTypeIds";
                pDecorativeTypeIds.Value = !String.IsNullOrEmpty(decorativeTypeIds) ? (object)decorativeTypeIds : DBNull.Value;
                pDecorativeTypeIds.DbType = DbType.String;

                var pRodsOptionIds = _dataProvider.GetParameter();
                pRodsOptionIds.ParameterName = "RodsOptionIds";
                pRodsOptionIds.Value = !String.IsNullOrEmpty(rodsOptionTypeIds) ? (object)rodsOptionTypeIds : DBNull.Value;
                pRodsOptionIds.DbType = DbType.String;

                var pPoleStyleIds = _dataProvider.GetParameter();
                pPoleStyleIds.ParameterName = "PoleStyleIds";
                pPoleStyleIds.Value = !String.IsNullOrEmpty(poleTypeIds) ? (object)poleTypeIds : DBNull.Value;
                pPoleStyleIds.DbType = DbType.String;

                var pAdjustableSizes = _dataProvider.GetParameter();
                pAdjustableSizes.ParameterName = "AdjustableSizes";
                pAdjustableSizes.Value = !String.IsNullOrEmpty(adjustableSizes) ? (object)adjustableSizes : DBNull.Value;
                pAdjustableSizes.DbType = DbType.String;
