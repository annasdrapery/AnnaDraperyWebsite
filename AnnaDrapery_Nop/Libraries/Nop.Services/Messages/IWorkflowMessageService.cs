...
namespace Nop.Services.Messages
{
    public partial interface IWorkflowMessageService
    {
        ...
        int SendPOSupplierNotification(PurchaseOrder po, POTemplateMessage poTemplate, List<OrderItem> orderItems, Order order, Vendor vendor, int languageId, Nop.Services.Catalog.IProductService productService = null);
        #endregion
