...
namespace Nop.Services.Messages
{
    public partial class MessageTokenProvider : IMessageTokenProvider
    {
        ...
        public virtual void AddPurchaseOrderTokens(IList<Token> tokens, PurchaseOrder purchaseOrder, int languageId)
        {
            tokens.Add(new Token("PO.PONumber", purchaseOrder.PONumber));
            
            //event notification
            _eventPublisher.EntityTokensAdded(purchaseOrder, tokens);
        }
