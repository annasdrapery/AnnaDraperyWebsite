...
namespace Nop.Services.Security
{
    ...
    public partial class StandardPermissionProvider : IPermissionProvider
    {
        ...
        public static readonly PermissionRecord AccessPagesUnderDesignerLogin = new PermissionRecord { Name = "Public store. Access the pages under Designer Login", SystemName = "AccessPagesUnderDesignerLogin", Category = "PublicStore" };
