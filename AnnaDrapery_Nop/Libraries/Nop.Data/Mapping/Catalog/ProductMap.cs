...
namespace Nop.Data.Mapping.Catalog
{
    public partial class ProductMap : NopEntityTypeConfiguration<Product>
    {
        public ProductMap()
        {
            ...
            this.Property(p => p.Return).HasPrecision(18, 4);
            this.Property(p => p.Clearance).HasPrecision(18, 4);
            this.Property(p => p.Projection).HasPrecision(18, 4);
            this.Property(p => p.PoleDiameter).HasPrecision(18, 4);
            this.Property(p => p.InnerDiameter).HasPrecision(18, 4);
            this.Property(p => p.OuterDiameter).HasPrecision(18, 4);
            this.Property(p => p.PoleDiameter).HasPrecision(18, 4);
            this.Property(p => p.NameInPO).HasMaxLength(400);
            this.Property(p => p.ExpectedProfit).HasPrecision(18, 4);
