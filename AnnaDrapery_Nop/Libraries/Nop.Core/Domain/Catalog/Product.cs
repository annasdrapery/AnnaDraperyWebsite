...
namespace Nop.Core.Domain.Catalog
{
    ...
    public partial class Product : BaseEntity, ILocalizedEntity, ISlugSupported, IAclSupported, IStoreMappingSupported
    {
        ...
        public int CollectionStyleId { get; set; }
        public int FinialStyleId { get; set; }
        public int AccessoriesStyleId { get; set; }      
        public int PoleStyleId { get; set; }
        public int BracketStyleId { get; set; }
