...
namespace Nop.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        public static string ConvertSizeToString(double size)
        {
            if (size == 0)
                return "0";
            string sSize = size.ToString().Replace(',', '.');
            if (sSize.IndexOf('.') < 0)
                return sSize.ToString();
            string returnSize = string.Empty;
            //string digitBeforeDecimal = sSize.Substring(0, sSize.IndexOf('.'));
            string digitAfterDecimal = sSize.Substring(sSize.IndexOf('.'));
        ...
        public static double ConvertStringToSize(string str)
        {
            str = str.Trim();
            if (str.IndexOf(' ') < 0)
            ...
            {
                case "1/8":
                    return double.Parse(vals[0] + ".125");
                case "1/4":
                    return double.Parse(vals[0] + ".25");
                case "3/8":
                    return double.Parse(vals[0] + ".375");
                case "1/2":
                    return double.Parse(vals[0] + ".5");
                case "5/8":
                    return double.Parse(vals[0] + ".625");
                case "3/4":
                    return double.Parse(vals[0] + ".75");
                case "7/8":
                    return double.Parse(vals[0] + ".875");
                default:
                    return double.Parse(str);
            }
        }
        public static List<System.Web.Mvc.SelectListItem> GetDimensionEvens(double selectedValue = 0, double minValue = 0, double maxValue = 1, double seed = 0.125)
        {
            var listEvens = new List<System.Web.Mvc.SelectListItem>();
            for (double i = minValue; i < maxValue; i += seed)
            {
                listEvens.Add(new System.Web.Mvc.SelectListItem() { Text = ConvertSizeToString(i)+" \"", Value = i.ToString(), Selected = i == selectedValue });
            }
            return listEvens;
        }
    }
