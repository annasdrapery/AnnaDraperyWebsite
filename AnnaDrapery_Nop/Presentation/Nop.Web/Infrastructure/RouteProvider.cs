...
namespace Nop.Web.Infrastructure
{
    public partial class RouteProvider : IRouteProvider
    {
        public void RegisterRoutes(RouteCollection routes)
        {
            ...
            //catalogs 
            routes.MapLocalizedRoute("Catalogs",
                            "catalogs",
                            new { controller = "Common", action = "Catalogs" },
                            new[] { "Nop.Web.Controllers" });
            //price list 
            routes.MapLocalizedRoute("PriceList",
                            "price-list",
                            new { controller = "Common", action = "PriceList" },
                            new[] { "Nop.Web.Controllers" });
            //pleated drapery order form
            routes.MapLocalizedRoute("DraperyOrderForm",
                            "drapery-order-form",
                            new { controller = "Common", action = "DraperyOrderForm" },
                            new[] { "Nop.Web.Controllers" });
            //rt rtb drapery order form
            routes.MapLocalizedRoute("RTRTBDraperyOrderForm",
                            "rt-rtb-drapery-order-form",
                            new { controller = "Common", action = "RTRTBDraperyOrderForm" },
                            new[] { "Nop.Web.Controllers" });
            //top treatment shades
            routes.MapLocalizedRoute("TopTreatmentsAndShades",
                            "top-treatments-shades",
                            new { controller = "Common", action = "TopTreatmentsAndShades" },
                            new[] { "Nop.Web.Controllers" });
            //customer credit application
            routes.MapLocalizedRoute("CustomerCreditApplication",
                            "customer-credit-application",
                            new { controller = "Common", action = "CustomerCreditApplication" },
                            new[] { "Nop.Web.Controllers" });
            //sale tax certificate
            routes.MapLocalizedRoute("SaleTaxCertificate",
                            "sale-tax-certificate",
                            new { controller = "Common", action = "SaleTaxCertificate" },
                            new[] { "Nop.Web.Controllers" });
            //sheer railroll order form
            routes.MapLocalizedRoute("SheerRailrollOrderForm",
                            "sheer-railroll-order-form",
                            new { controller = "Common", action = "SheerRailrollOrderForm" },
                            new[] { "Nop.Web.Controllers" });
            //sheer vertical order form
            routes.MapLocalizedRoute("SheerVerticalOrderForm",
                            "sheer-vertical-order-form",
                            new { controller = "Common", action = "SheerVerticalOrderForm" },
                            new[] { "Nop.Web.Controllers" });
            //ripple fold order form
            routes.MapLocalizedRoute("RippleFoldOrderForm",
                            "ripplefold-order-form",
                            new { controller = "Common", action = "RippleFoldOrderForm" },
                            new[] { "Nop.Web.Controllers" });
            //designer login landing
            routes.MapLocalizedRoute("DesignerLoginLanding",
                            "designer-login-landing",
                            new { controller = "Common", action = "DesignerLoginLanding" },
                            new[] { "Nop.Web.Controllers" });
        }
