...
namespace Nop.Web.Infrastructure.Cache
{
        ...
        IConsumer<EntityUpdated<ShoppingCartItem>>
    {
        ...
        public const string BRAND_TEMPLATE_MODEL_KEY = "Nop.pres.brandtemplate-{0}";
        public const string BRAND_TEMPLATE_PATTERN_KEY = "Nop.pres.brandtemplate";
        ...
        public const string PRODUCT_PICTURELIST_MODEL_KEY = "Nop.pres.product.listpictures-{0}-{1}-{2}-{3}-{4}-{5}";
        ...
        public const string BRAND_PICTURE_MODEL_KEY = "Nop.pres.brand.picture-{0}-{1}-{2}-{3}-{4}-{5}";
        public const string BRAND_PICTURE_PATTERN_KEY = "Nop.pres.brand.picture";
