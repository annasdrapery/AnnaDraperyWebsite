...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductOverviewModel : BaseNopEntityModel
    {
        public ProductOverviewModel()
        {
            ...
            ListPictureModel = new List<PictureModel>();
            ListColorPictureModel = new List<PictureModel>();
        }
        ...
        public string PoleStyle { get; set; }
        ...
        public IList<PictureModel> ListPictureModel { get; set; }
        //colors
        public IList<PictureModel> ListColorPictureModel { get; set; }
