...
namespace Nop.Web.Models.Catalog
{
    ...
    public partial class CatalogPagingFilteringModel : BasePageableModel
    {
        ...
        public CatalogPagingFilteringModel()
        {
            ...
            this.AvailableComponents = new List<SelectListItem>();
            this.AvailablePoleDiameters = new List<SelectListItem>();
            this.AvailableCollectionStyles = new List<SelectListItem>();
            this.AvailableBrands = new List<SelectListItem>();
            this.AvailableFinialStyles = new List<SelectListItem>();
            this.AvailablePoleStyles = new List<SelectListItem>();
            this.AvailablePoleLengths = new List<SelectListItem>();
            this.AvailableBracketStyles = new List<SelectListItem>();
            this.AvailableInnerDiameters = new List<SelectListItem>();
            this.AvailableOuterDiameters = new List<SelectListItem>();
            this.AvailableAccessoriesStyles = new List<SelectListItem>();
            this.AvailableRodsOptions = new List<SelectListItem>();
            this.AvailableRodsTypes = new List<SelectListItem>();
            this.AvailableDecorativeTypes = new List<SelectListItem>();
            this.AvailableAdjustableSizes = new List<SelectListItem>();
        }
        ...
        /// <summary>
        /// Selected Pole Diameters
        /// </summary>
        public string Pdm { get; set; }
        /// <summary>
        /// Selected Collection Style
        /// </summary>
        ...
        /// <summary>
        /// Selected Finial Styles
        /// </summary>
        public string Fs { get; set; }
        /// <summary>
        /// Selected Pole Styles
        /// </summary>
        ...
        /// <summary>
        /// Selected Bracket Style
        /// </summary>
        public string Bs { get; set; }
        /// <summary>
        /// Selected Inner Diameter
        /// </summary>
        ...
        /// <summary>
        /// Selected Rods Options
        /// </summary>
        public string Rp { get; set; }
        /// <summary>
        /// Selected Decorative Types
        /// </summary>
        public string Dt { get; set; }
        /// <summary>
        /// Selected Adjustable Sizes
        /// </summary>
        public string Adjs { get; set; }

        public IList<SelectListItem> AvailableComponents { get; set; }
