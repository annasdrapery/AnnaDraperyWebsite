...
namespace Nop.Web.Models.Catalog
{
    public partial class ProductDetailsModel : BaseNopEntityModel
    {
        public ProductDetailsModel()
        {
            ...
            AvailableRodWidths = new List<SelectListItem>();
            AvailableRodWidthEvens = new List<SelectListItem>();
        ...
        public IList<SelectListItem> AvailableRodWidths { get; set; }
        public IList<SelectListItem> AvailableRodWidthEvens { get; set; }
        ...
        public VendorBriefInfoModel BrandModel { get; set; }
