    ...
    public partial class ProductAttributeController : BaseAdminController
    {
        ...
        public ActionResult PredefinedProductAttributeValueList(int productAttributeId, DataSourceRequest command)
        {
            ...
            var gridModel = new DataSourceResult
            {
                ...
                {
                    //picture
                    var attributePicture = _pictureService.GetPictureById(x.PictureId);
                    x.PictureUrl = _pictureService.GetPictureUrl(attributePicture, 75, true);
        ...
        public ActionResult PredefinedProductAttributeValueEditPopup(int id)
        {
            ...
            var model = new PredefinedProductAttributeValueModel
            {
                ...
                PictureId = ppav.PictureId,
                SupplierAttributeCode = ppav.SupplierAttributeCode,
                SupplierPartNumber = ppav.SupplierPartNumber,
                ExpectedProfit = ppav.ExpectedProfit,
                IsDisplayPriceWithFee = ppav.IsDisplayPriceWithFee
            };
            //locales
            AddLocales(_languageService, model.Locales, (locale, languageId) =>
            {
        ...
        public ActionResult PredefinedProductAttributeValueEditPopup(string btnId, string formId, PredefinedProductAttributeValueModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                ppav.ExpectedProfit = model.ExpectedProfit;
                ppav.SupplierPartNumber = model.SupplierPartNumber;
                ppav.SupplierAttributeCode = model.SupplierAttributeCode;
                ppav.PictureId = model.PictureId;
                ppav.IsDisplayPriceWithFee = model.IsDisplayPriceWithFee;
