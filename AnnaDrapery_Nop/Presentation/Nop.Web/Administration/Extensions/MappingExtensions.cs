...
namespace Nop.Admin.Extensions
{
    public static class MappingExtensions
    {
        ...
        {
            return entity.MapTo<PurchaseOrder, PurchaseOrderModel>();
        }

        public static PurchaseOrder ToEntity(this PurchaseOrderModel model)
        {
            return model.MapTo<PurchaseOrderModel, PurchaseOrder>();
        }

        public static PurchaseOrder ToEntity(this PurchaseOrderModel model, PurchaseOrder destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        public static ShippingFeeByOrderTotalModel ToModel(this ShippingFeeByOrderTotal entity)
        {
            return entity.MapTo<ShippingFeeByOrderTotal, ShippingFeeByOrderTotalModel>();
        }

        public static ShippingFeeByOrderTotal ToEntity(this ShippingFeeByOrderTotalModel model)
        {
            return model.MapTo<ShippingFeeByOrderTotalModel, ShippingFeeByOrderTotal>();
        }

        public static ShippingFeeByOrderTotal ToEntity(this ShippingFeeByOrderTotalModel model, ShippingFeeByOrderTotal destination)
        {
            return model.MapTo(destination);
        }
        #endregion
        ...
        public static BrandTemplateModel ToModel(this BrandTemplate entity)
        {
            return entity.MapTo<BrandTemplate, BrandTemplateModel>();
        }

        public static BrandTemplate ToEntity(this BrandTemplateModel model)
        {
            return model.MapTo<BrandTemplateModel, BrandTemplate>();
        }

        public static BrandTemplate ToEntity(this BrandTemplateModel model, BrandTemplate destination)
        {
            return model.MapTo(destination);
        }
