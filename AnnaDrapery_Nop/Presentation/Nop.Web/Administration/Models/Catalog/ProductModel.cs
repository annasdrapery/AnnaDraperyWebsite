...
namespace Nop.Admin.Models.Catalog
{
    ...
    public partial class ProductModel : BaseNopEntityModel, ILocalizedModel<ProductLocalizedModel>
    {
        public ProductModel()
        {
            ...
            AvailableCollectionStyles = new List<SelectListItem>();
            AvailableFinialStyles = new List<SelectListItem>();
            AvailableAccessoriesStyles = new List<SelectListItem>();
            AvailablePoleStyles = new List<SelectListItem>();
            AvailableBracketStyles = new List<SelectListItem>();
            AvailablePoleDiameters = new List<SelectListItem>();
            AvailableInnerDiameters = new List<SelectListItem>();
            AvailableOuterDiameters = new List<SelectListItem>();
            AvailablePoleLengths = new List<SelectListItem>();
            AvailableRodsOptions = new List<SelectListItem>();
            AvailableRodsTypes = new List<SelectListItem>();
            AvailableDecorativeTypes = new List<SelectListItem>();
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.NameInPO")]
        [AllowHtml]
        public string NameInPO { get; set; }
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Brand")]
        ...
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Packaged")]
        public string Packaged { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Material")]
        public string Material { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.CollectionStyle")]
        public string CollectionStyleId { get; set; }
        public IList<SelectListItem> AvailableCollectionStyles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.FinialStyle")]
        public string FinialStyleId { get; set; }
        public IList<SelectListItem> AvailableFinialStyles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AccessoriesStyle")]
        public string AccessoriesStyleId { get; set; }
        public IList<SelectListItem> AvailableAccessoriesStyles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PoleStyle")]
        public string PoleStyleId { get; set; }
        public IList<SelectListItem> AvailablePoleStyles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.BracketStyle")]
        public string BracketStyleId { get; set; }
        public IList<SelectListItem> AvailableBracketStyles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Return")]
        public decimal Return { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Clearance")]
        public decimal Clearance { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.Projection")]
        public decimal Projection { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PoleDiameter")]
        public decimal PoleDiameter { get; set; }
        public IList<SelectListItem> AvailablePoleDiameters { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.InnerDiameter")]
        public decimal InnerDiameter { get; set; }
        public IList<SelectListItem> AvailableInnerDiameters { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.OuterDiameter")]
        public decimal OuterDiameter { get; set; }
        public IList<SelectListItem> AvailableOuterDiameters { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PoleLength")]
        public decimal PoleLength { get; set; }
        public IList<SelectListItem> AvailablePoleLengths { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.RodsType")]
        public int RodsTypeId { get; set; }
        public IList<SelectListItem> AvailableRodsTypes { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.RodsOption")]
        public int RodsOptionId { get; set; }
        public IList<SelectListItem> AvailableRodsOptions { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.DecorativeType")]
        public int DecorativeTypeId { get; set; }
        public IList<SelectListItem> AvailableDecorativeTypes { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.AdjustableSize")]
        public string AdjustableSize { get; set; }
        public IList<SelectListItem> AvailableAdjustableSizes { get; set; }

        [NopResourceDisplayName("Admin.Catalog.Products.Fields.ExpectedProfit")]
        public decimal ExpectedProfit { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.NumberOfFinials")]
        public int NumberOfFinials { get; set; }
        public string PackagedFinials { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.NumberOfPoles")]
        public int NumberOfPoles { get; set; }
        public string PackagedPoles { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.NumberOfBrackets")]
        public int NumberOfBrackets { get; set; }
        public string PackagedBrackets { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MinRodWidth")]
        public int MinRodWidth { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.MaxRodWidth")]
        public int MaxRodWidth { get; set; }
        public int WidthOrUnder { get; set; }
        [NopResourceDisplayName("Admin.Catalog.Products.Fields.PriceEachAdditionalFoot")]
        public decimal PriceEachAdditionalFoot { get; set; }

        public int? FinialProductId { get; set; }
        public string FinialProductName { get; set; }
        public int? PoleProductId { get; set; }
        public string PoleProductName { get; set; }
        ...
        public partial class ProductAttributeValueModel : BaseNopEntityModel, ILocalizedModel<ProductAttributeValueLocalizedModel>
        {
            ...
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.ExpectedProfit")]
            public decimal ExpectedProfit { get; set; }
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.SupplierPartNumber")]
            [AllowHtml]
            public string SupplierPartNumber { get; set; }
            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.SupplierAttributeCode")]
            [AllowHtml]
            public string SupplierAttributeCode { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.IsDisplayPriceWithFee")]
            public bool IsDisplayPriceWithFee { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.FinialPartNumber")]
            public string FinialPartNumber { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.PolePartNumber")]
            public string PolePartNumber { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.BracketPartNumber")]
            public string BracketPartNumber { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.RingPartNumber")]
            public string RingPartNumber { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.Packaged")]
            public string Packaged { get; set; }

            [NopResourceDisplayName("Admin.Catalog.Products.ProductAttributes.Attributes.Values.Fields.ComponentProductId")]
            ...
            /// <summary>
            /// for checking input finial, pole, bracket, ring part number
            /// </summary>
            public int ProductTypeId { get; set; }
