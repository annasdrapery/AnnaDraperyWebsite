    ...
    public class AutoMapperStartupTask : IStartupTask
    {
        public void Execute()
        {
            ...
            Mapper.CreateMap<Brand, BrandModel>()
                .ForMember(dest => dest.AvailableBrandTemplates, mo => mo.Ignore())
                .ForMember(dest => dest.Locales, mo => mo.Ignore())
                .ForMember(dest => dest.SeName, mo => mo.MapFrom(src => src.GetSeName(0, true, false)))
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore())
            ...
            Mapper.CreateMap<PurchaseOrder, PurchaseOrderModel>()
               .ForMember(dest => dest.VendorName, mo => mo.Ignore());
            Mapper.CreateMap<PurchaseOrderModel, PurchaseOrder>()
                .ForMember(dest => dest.Deleted, mo => mo.Ignore());
            //vendors
            ...
            Mapper.CreateMap<Product, ProductModel>()
                ...
                .ForMember(dest => dest.VendorName, mo => mo.Ignore())
                .ForMember(dest => dest.ProductTemplateName, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableCollectionStyles, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableFinialStyles, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableAccessoriesStyles, mo => mo.Ignore())
                .ForMember(dest => dest.AvailablePoleStyles, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableBracketStyles, mo => mo.Ignore())
                .ForMember(dest => dest.AvailablePoleDiameters, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableInnerDiameters, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableOuterDiameters, mo => mo.Ignore())
                .ForMember(dest => dest.AvailablePoleLengths, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableRodsTypes, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableRodsOptions, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableDecorativeTypes, mo => mo.Ignore())
                .ForMember(dest => dest.AvailableAdjustableSizes, mo => mo.Ignore())
                .ForMember(dest => dest.FinialProductName, mo => mo.Ignore())
                .ForMember(dest => dest.PoleProductName, mo => mo.Ignore())
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            ...
            //shipping fee 
            Mapper.CreateMap<ShippingFeeByOrderTotal, ShippingFeeByOrderTotalModel>();
            Mapper.CreateMap<ShippingFeeByOrderTotalModel, ShippingFeeByOrderTotal>();
            ...
            //brand template
            Mapper.CreateMap<BrandTemplate, BrandTemplateModel>()
                .ForMember(dest => dest.CustomProperties, mo => mo.Ignore());
            Mapper.CreateMap<BrandTemplateModel, BrandTemplate>();
            //product template
