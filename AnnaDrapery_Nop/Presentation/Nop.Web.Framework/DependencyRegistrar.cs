...
namespace Nop.Web.Framework
{
    ...
    public class DependencyRegistrar : IDependencyRegistrar
    {
        ...
        public virtual void Register(ContainerBuilder builder, ITypeFinder typeFinder, NopConfig config)
        {
            ...
            builder.RegisterType<BrandTemplateService>().As<IBrandTemplateService>().InstancePerLifetimeScope();
            ...
            builder.RegisterType<POTemlateMessageService>().As<IPOTemplateMessageService>().InstancePerLifetimeScope();
